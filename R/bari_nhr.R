...
#'   \item{Ship_categ}{dbl }
#'   \item{ntug}{dbl }
#'   \item{Emiss_HOT_MDGO}{dbl }
#'   \item{Emiss_MAN_MDGO}{dbl }
#'   \item{Emiss_tug_MDGO}{dbl }
#'   \item{Emiss_Cter_MDGO}{dbl }
#'   \item{Emiss_Cext_MDGO}{dbl }
#'   \item{Emiss_HOT_BFO}{dbl }
#'   \item{Emiss_MAN_BFO}{dbl }
#'   \item{Emiss_tug_BFO}{dbl }
#'   \item{Emiss_Cter_BFO}{dbl }
